...
import com.luncert.vibotech.foundation.client.VibotechClient;
...
public class ViboTechMod {
  ...
  public static void onCtor() {
    ...
    DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> VibotechClient.onCtorClient(modEventBus, forgeEventBus));
  }
