...
public class TransportMachineComponent extends BaseViboComponent {
    ...
    public final Map<String, Double> getAircraftPosition() {
        Vec3 pos = accessor.transportMachine.getAircraftPosition();
    ...
    public final Map<String, Object> getAircraftFacing() {
        Direction direction = accessor.transportMachine.getAircraftFacing();
    ...
    public final int calcRotationTo(String a, int step) throws LuaException {
        ...
        Direction facingDirection = accessor.transportMachine.getAircraftFacing();
